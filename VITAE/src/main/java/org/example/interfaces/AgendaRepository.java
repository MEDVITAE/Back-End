...
public interface AgendaRepository extends JpaRepository<Agenda, Long> {
    ...
    @Query(value = "select agenda.*,u.cpf,u.nome from usuario as u join agenda on fk_usuario = u.id_usuario join hospital on id_hospital = agenda.fk_Hospital  left join doacao on id_agenda = fk_agenda where agenda.fk_Hospital = :id  and  doacao.fk_agenda IS NULL order by horario", nativeQuery = true)
